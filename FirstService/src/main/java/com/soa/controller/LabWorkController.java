...
import com.soa.dto.LabWorkListDTO;
...
public class LabWorkController {
    ...
    @GetMapping("/discipline/{discipline-id}/make-hardcore")
    public ResponseEntity<LabWorkListDTO> makeHardcore(@PathVariable("discipline-id") Integer id) {
    ...
    @GetMapping("/{id}/difficulty/increase/{steps-count}")
