...
public class LabWorkService {
    ...
    public LabWorkListDTO makeHardcore(Integer id) {
        ...
        return new LabWorkListDTO().setLabWorkResponseDtos(labWorkEntities.stream().map(labWorkConverter::convertToDto).toList());
    }
